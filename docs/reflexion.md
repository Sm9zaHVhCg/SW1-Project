...
Die Projektidee stand schon früh fest und man entschied sich für den Technologie-Stack mit Angular im Frontend und -- im Backend.
...
Wie bei der technischen Umsetzung angeführt, fehlte gegen Ende eben die Zeit, entsprechend ist das "Key Learning" sich früher an eine Aufgabe zu setzen, da man den Aufwand immer etwas unterschätzt.
Entsprechend blieben u.a. noch ein paar Punkte noch offen:
...
- Sonarqube reparieren/richtig konfigurieren für die CI/CD pipeline